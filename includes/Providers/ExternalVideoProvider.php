...
abstract class ExternalVideoProvider {
	 ...
	 * @return string
	 */
	abstract public function getEmbed( int $width, int $height ): string;
	 ...
	 * @return string
	 */
	abstract public function getMimeMinor(): string;

	/**
	 * The minimum width for the embed; below this point, return a thumbnail
	 * @return int
	 */
	abstract public function getMinimumWidthForEmbed(): int;

	/**
	 * The minimum height for an embed - below this, return a thumbnail
	 * @return int
	 */
	abstract public function getMinimumHeightForEmbed(): int;
}
