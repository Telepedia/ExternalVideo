**ExternalVideo** is a MediaWiki extension for embedding videos from external providers into MediaWiki. Whilst there are some extensions to embed videos in MediaWiki, these do not fit our needs.
